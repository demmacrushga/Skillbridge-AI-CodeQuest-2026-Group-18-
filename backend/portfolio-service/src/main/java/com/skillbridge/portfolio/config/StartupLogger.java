...
public class StartupLogger {
    ...
    public void logStartupInfo() {
        ...
        log.info("==========================================================");
        log.info("  SkillBridge AI — Portfolio Service is running");
        log.info("  Local:      {}", localUrl);
        log.info("  Swagger UI: {}/swagger-ui/index.html", localUrl);
        log.info("  Health:     {}/portfolio/health", localUrl);
        log.info("  Network:    {}", discoverNetworkUrl(port));
        log.info("==========================================================");
    }

    private String discoverNetworkUrl(String port) {
        try {
